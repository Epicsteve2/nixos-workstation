...
in {
  imports = [ # Include the results of the hardware scan.
    # <home-manager/nixos> # this is not working wtf
  ...
  services.xserver = {
    ...
    displayManager = {
      lightdm = {
        ...
        #extraConfig = "display-setup-script=xrandr --output default --mode 1920x1080\n";
        #greeters.gtk = {
...
#/home/stephen/code-monkey/nixos-workstation/GRUB-Theme/Nakano Miku/Miku
